...
_V1LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EUCLIDEAN_LW_LOSS', index=13, number=40,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EUCLIDEAN_HARDMINING_LOSS', index=14, number=41,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='euclidean_hardmining_loss_param', full_name='caffe.LayerParameter.euclidean_hardmining_loss_param', index=28,
...
_EUCLIDEANHARDMININGLOSSPARAMETER = _descriptor.Descriptor(
  name='EuclideanHardminingLossParameter',
  full_name='caffe.EuclideanHardminingLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hardmining_ratio', full_name='caffe.EuclideanHardminingLossParameter.hardmining_ratio', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMAGEDATAPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='downsamp_times', full_name='caffe.ImageDataParameter.downsamp_times', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='base_sigma', full_name='caffe.ImageDataParameter.base_sigma', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='times_split', full_name='caffe.ImageDataParameter.times_split', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_crop', full_name='caffe.ImageDataParameter.max_crop', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_crop', full_name='caffe.ImageDataParameter.min_crop', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='neighbor_num', full_name='caffe.ImageDataParameter.neighbor_num', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ksize_param', full_name='caffe.ImageDataParameter.ksize_param', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sigma_param', full_name='caffe.ImageDataParameter.sigma_param', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dmap_online', full_name='caffe.ImageDataParameter.dmap_online', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale_param', full_name='caffe.ImageDataParameter.scale_param', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_augment', full_name='caffe.ImageDataParameter.is_augment', index=10,
      number=28, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='source', full_name='caffe.ImageDataParameter.source', index=11,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.ImageDataParameter.batch_size', index=12,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='rand_skip', full_name='caffe.ImageDataParameter.rand_skip', index=13,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='caffe.ImageDataParameter.shuffle', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='new_height', full_name='caffe.ImageDataParameter.new_height', index=15,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='new_width', full_name='caffe.ImageDataParameter.new_width', index=16,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='is_color', full_name='caffe.ImageDataParameter.is_color', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='caffe.ImageDataParameter.scale', index=18,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mean_file', full_name='caffe.ImageDataParameter.mean_file', index=19,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_size', full_name='caffe.ImageDataParameter.crop_size', index=20,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mirror', full_name='caffe.ImageDataParameter.mirror', index=21,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='root_folder', full_name='caffe.ImageDataParameter.root_folder', index=22,
...
_V1LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='euclidean_hardmining_loss_param', full_name='caffe.V1LayerParameter.euclidean_hardmining_loss_param', index=22,
...
_LAYERPARAMETER.fields_by_name['euclidean_hardmining_loss_param'].message_type = _EUCLIDEANHARDMININGLOSSPARAMETER
...
_V1LAYERPARAMETER.fields_by_name['euclidean_hardmining_loss_param'].message_type = _EUCLIDEANHARDMININGLOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['EuclideanHardminingLossParameter'] = _EUCLIDEANHARDMININGLOSSPARAMETER
...
class EuclideanHardminingLossParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _EUCLIDEANHARDMININGLOSSPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.EuclideanHardminingLossParameter)
